    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-md-6 mx-auto" style="border: 1px solid #000;">
          <h4 class="text-center mt-2"><img src="../assets/image/logo1.png" width="40" align="middle"><span class="mt-3">Resto Asa</span></h4>
          <hr>
          <div class="row mt-3">
            <div class="col-md-6">
          ...
          <div class="row">
            <?php 
            if(mysqli_num_rows($detail_order) > 0) {
              foreach ($detail_order as $do) :
                if(isset($do['id_masakan'])) {
            ...
            <?php 
              ...
              echo '<div class="col-12 text-center">No order details found</div>';
            }
            ?>
          </div>
          <hr>
