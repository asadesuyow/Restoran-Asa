<div class="container mt-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            <a href="index.php?makanan" class="btn btn-primary">
                <i class="fas fa-utensils me-2"></i>
                Data Makanan
            </a>
            <a href="index.php?minuman" class="btn btn-info text-white">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <?php
                            $total = mysqli_fetch_assoc(mysqli_query($kon, "SELECT COUNT(*) as count FROM tb_masakan WHERE kategori_masakan='Makanan'"))['count'];
                            ?>
            ...
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <?php
                            $tersedia = mysqli_fetch_assoc(mysqli_query($kon, "SELECT COUNT(*) as count FROM tb_masakan WHERE kategori_masakan='Makanan' AND status_masakan=1"))['count'];
                            ?>
            ...
            <div class="card bg-danger text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <?php
                            $tidak_tersedia = mysqli_fetch_assoc(mysqli_query($kon, "SELECT COUNT(*) as count FROM tb_masakan WHERE kategori_masakan='Makanan' AND status_masakan=0"))['count'];
                            ?>
            ...
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <?php
                            $result = mysqli_fetch_assoc(mysqli_query($kon, "SELECT MIN(harga_masakan) as min, MAX(harga_masakan) as max FROM tb_masakan WHERE kategori_masakan='Makanan'"));
                            ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="tabel">
                    ...
                    <tbody>
                        <?php
                        $i = 1;
                        $sql = mysqli_query($kon, "SELECT * FROM tb_masakan WHERE kategori_masakan='Makanan' ORDER BY nama_masakan ASC");
